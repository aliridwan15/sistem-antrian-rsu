...
<head>
    ...
    <style>
        ...
        /* --- USER DROPDOWN STYLE (BARU) --- */
        .user-dropdown-link {
            color: #1B9C85 !important; /* Warna text hijau */
            padding: 8px 15px;         /* Jarak dalam agar background terlihat bagus */
            border-radius: 30px;       /* Membuat bentuk oval/kapsul */
            transition: all 0.3s ease; /* Efek halus */
        }

        /* Efek saat Hover atau Menu Terbuka */
        .user-dropdown-link:hover, 
        .user-dropdown-link[aria-expanded="true"] {
            background-color: #e0f2ef; /* Latar belakang hijau muda tipis */
            color: #14806c !important; /* Warna text jadi lebih gelap */
        }
        
        /* Rotasi panah saat menu terbuka */
        .user-dropdown-link[aria-expanded="true"] .bi-chevron-down {
        ...
        .dropdown-toggle::after { content: none; } /* Hapus panah bawaan bootstrap */

        /* --- HERO SECTION --- */
        .hero { 
            position: relative; padding: 100px 0; min-height: 84vh; display: flex; align-items: center; justify-content: center;
            background: url('{{ asset('images/rsanna.jpg') }}') center/cover no-repeat; overflow: hidden;
        }
        .hero::before { 
            content: ""; position: absolute; inset: 0; background: rgba(255, 255, 255, 0.75); z-index: 0; 
        }
        ...
        .poli-card:hover { 
            background-color: #1B9C85; transform: translateY(-5px); 
        ...
        /* --- FOOTER --- */
        footer { 
            background-color: white; padding-top: 3rem; padding-bottom: 1.5rem; 
                ...
                <ul class="navbar-nav ms-auto align-items-center mt-3 mt-lg-0">
                    ...
                    <li class="nav-item ms-lg-3 mt-3 mt-lg-0">
                        <div class="contact-wrapper">
                            ...
                            <a href="https://wa.me/6282278888001" target="_blank" class="social-link" title="WhatsApp">
                                <i class="bi bi-whatsapp"></i>
                            </a>
                            <a href="https://www.instagram.com/annamedikamadura?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" class="social-link" title="Instagram">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <a href="https://www.google.com/maps/place/RSU+Anna+Medika+Madura/@-7.0496739,112.729804,15z/data=!4m5!3m4!1s0x0:0x79ff9f7e3ebc3566!8m2!3d-7.0496739!4d112.729804?sa=X&ved=2ahUKEwjwtvjp1qP8AhVW3nMBHWZZCIwQ_BJ6BAhfEAg&coh=164777&entry=tt&shorturl=1" target="_blank" class="footer-link">
                        Alamat Kami <i class="bi bi-arrow-right ms-1"></i>
                    </a>
                </div>
            </div>
